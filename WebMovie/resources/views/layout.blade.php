...
<html lang="vi">
   <head>
      ...
      <link rel='stylesheet' id='wp-block-library-css' href='{{asset('css/style.css')}}' media='all' />
   ...
   <body class="home blog halimthemes halimmovies" data-masonry="">
      <header id="header">
         <div class="container">
            <div class="row" id="headwrap">
               <div class="col-md-3 col-sm-6 slogan" style="margin-top: -12px;">
                  <a class="logo"  href="{{route('homepage')}}" >
                  <img style="width:100px" src="{{ asset('img/zyro-image.png') }}" alt="Logo Phim Hay">
                  </a>
               </div>
               <div style="margin-top:10px;">
                           ...
                           <div class="form-group">
                              <div class="input-group col-xs-12">
                                 <form action="{{route('tim-kiem')}}" method="GET">
                                    ...
                                    <button style="display:none" class="btn btn-primary">Tìm kiếm</button>
                                    <i class="animate-spin hl-spin4 hidden"></i>
                                 </form>
                              </div>
                           </div>
                           <!-- <ul class="ui-autocomplete ajax-results hidden"></ul> -->
                           <ul class="ui-autocomplete ajax-results " class="list-group" id="result" style="list-style-type: none;display:none ">
                           </ul>
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="col-md-4 hidden-xs">
                    ...
                    <div class="user-account-area" style="text-align: center;">
                        <!-- Nút bấm hiển thị modal đăng nhập/đăng ký -->
                        <button class="login-signup-btn" data-toggle="modal" data-target="#loginSignupModal" style="background-color: rgba(0, 152, 210, 0.07); color: #FFF; padding: 10px 20px; border-radius: 5px; border: none; cursor: pointer;">Đăng Nhập / Đăng Ký</button>
                        ...
                        <div class="modal-dialog" role="document">
                            ...
                            <!-- Phần đầu modal với tab đăng nhập và đăng ký -->
                            ...
                            <!-- Phần thân modal với form đăng nhập và đăng ký -->
               ...
               <div class="collapse navbar-collapse" id="halim">
                  <div class="menu-menu_1-container">
                     <ul id="menu-menu_1" class="nav navbar-nav navbar-left">
                        ...
                        <li class="mega dropdown">
                           <a title="Thể Loại" href="#" data-toggle="dropdown" class="dropdown-toggle" aria-haspopup="true">Năm <span class="caret"></span></a>
                           <ul role="menu" class=" dropdown-menu">
      ...
      <div id="fb-root"></div>
      <script async defer crossorigin="anonymous" src="https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v19.0" nonce="1P9Qp5Pt"></script>
                    ...
                    $.getJSON('/json_file/movies.json', function(data) {
                        $.each(data, function(key, value) {
                            if (value.title.search(expression) != -1 || value.description.search(expression) != -1) {
                                var imageSrc = value.image.match(/^http/) ? value.image : 'public/upload/movie/' + value.image;
                                var listItem = $('<li>').addClass('list-group-item').css({
                                    'border': 'none',
                                    'font-size': '12px',
                                    'float': 'left',
                                    'cursor': 'pointer'
                                ...
                                listItem.on('click', function() {
                                    window.location.href = "{{route('tim-kiem')}}";
                                });
