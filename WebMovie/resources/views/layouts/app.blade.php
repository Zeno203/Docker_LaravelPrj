...
<head>
    ...
    <meta name="keywords" content="Admin Phim Hay" />
...
<body class="cbp-spmenu-push">
    ...
    <div class="main-content">
                    ...
                    <div class="navbar-header">
                        ...
                        <h1>
                            <a class="navbar-brand" href="{{url('/home')}}"><span class="fa fa-area-chart"></span>
                                Admin<span class="dashboard_text">Manage dashboard</span></a>
                        </h1>
                    </div>
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="sidebar-menu">
                            ...
                            <li class="treeview active {{($segment == 'category')?'active':''}} ">
                                ...
                                <ul class="treeview-menu" style="display: {{ ($segment == 'category') ? 'block' : 'none' }}" >
                                    <li>
                            ...
                            <li class="treeview active {{($segment == 'country')?'active':''}} ">
                                ...
                                <ul class="treeview-menu" style="display: {{ ($segment == 'country') ? 'block' : 'none' }}">
                                    <li>
                                        <a href="{{route('country.create')}}"><i class="fa fa-angle-right"></i>Thêm quốc
                                            gia </a>
                                    </li>
                                    <li>
                            ...
                            <li class="treeview active {{($segment == 'genre') ? 'active': ''}} ">
                                ...
                                <ul class="treeview-menu" style="display: {{ ($segment == 'genre') ? 'block' : 'none' }}">
                                    <li>
                            ...
                            <li class="treeview active {{($segment == 'movie')?'active':''}} ">
                                ...
                                <ul class="treeview-menu" style="display: {{ ($segment == 'movie') ? 'block' : 'none' }}">
                                    <li>
                                        <a href="{{route('movie.create')}}"><i class="fa fa-angle-right"></i>Thêm phim
                                        </a>
                                    </li>
                                    <li>
                            ...
                            <li class="treeview active {{($segment == 'episode')?'active':''}} ">
                                ...
                                <ul class="treeview-menu" style="display: {{ ($segment == 'episode') ? 'block' : 'none' }}" >
                                    <li>
                            ...
                            <li class="treeview active {{($segment == 'leech')?'active':''}} ">
                                <a href="#">
                                    <i class="fa fa-video-camera "></i>
                                    <span>Leech phim</span>
                                    <i class="fa fa-angle-left pull-right"></i>
                                </a>
                                <ul class="treeview-menu" style="display: {{ ($segment == 'leech') ? 'block' : 'none' }}" >
                                    <li>
                                        <a href="{{route('leech')}}"><i class="fa fa-angle-right"></i>Thông tin phim</a>
                                    </li>
                                    <li>
                                        <a href="{{route('leechSreachMovie')}}"><i class="fa fa-angle-right"></i>Tìm kiếm phim</a>
                                    </li>
                                </ul>
                            </li>
                            ...
                            <ul class="dropdown-menu drp-mnu">
                                ...
                                <li>
                                    ...
                                    <form action="{{route('logout')}}" method="POST">
                                        ...
                                        <input class="btn btn-danger btn-sm" type="submit" name="logout" value="Logout">
                                    </form>
                                </li>
                            </ul>
                        </li>
                ...
                <div class="col_3">
                    <div class="col-md-3 widget widget1">
                        <div class="r3_counter_box">
                            ...
                            <div class="stats">
                                <h5><strong>{{$totalMovies}}</strong></h5>
                    ...
                    <div class="col-md-3 widget widget1">
                        <div class="r3_counter_box">
                            ...
                            <div class="stats">
                                <h5><strong>{{$totalCountries}}</strong></h5>
                                <span>Quốc gia</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 widget widget1">
                        <div class="r3_counter_box">
                            ...
                            <div class="stats">
                                <h5><strong>{{$totalCategories}}</strong></h5>
                                <span>Danh mục</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 widget widget1">
                        <div class="r3_counter_box">
                            ...
                            <div class="stats">
                                <h5><strong>{{$totalGenres}}</strong></h5>
                                <span>Thể loại</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 widget">
                        <div class="r3_counter_box">
                            ...
                            <div class="stats">
                                <h5><strong>{{$todayVisitsCount}}</strong></h5>
                                <span>Số lượt truy cập hôm nay</span>
                            </div>
                        </div>
                    </div>
                    <div class="clearfix"></div>
        ...
        <script src="{{asset('backend/js/export.min.js')}}" type="text/javascript"></script>
        ...
        <!-- for amcharts js -->
        <script src="{{asset('backend/js/index1.js')}}" type="text/javascript"></script>
        <div class="footer">
            <p>
                &copy; 2024 Glance Design Dashboard. All Rights Reserved | Design by
                <a href="#" target="_blank">Duy</a>
            </p>
        </div>
    ...
    <script src="{{asset('backend/js/SimpleChart.js')}}" type="text/javascript"></script>
    <script>
        var graphdata1 = {
            linecolor: '#CCA300',
            title: 'Monday',
        ...
        $('.category_choose').change(function() {
            // Lấy movie_id từ thuộc tính id của thẻ select
            var movie_id = $(this).attr('id');
            var category_id = $(this).val();

            // Gửi yêu cầu Ajax để cập nhật category_id cho bộ phim
            $.ajax({
    ...
    <script type="text/javascript">
        document.getElementById('detailForm').onsubmit = function() {
            var slugValue = document.getElementById('convert_slug').value;
            this.action = '/leech-movieDetail/' + encodeURIComponent(slugValue);
        };
    </script>
